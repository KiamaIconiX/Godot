 ...
 */
final class Version20250209224732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id SERIAL NOT NULL, client_id INT NOT NULL, status VARCHAR(255) NOT NULL, montant_total INT NOT NULL, date_creation TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE plat (id SERIAL NOT NULL, nom VARCHAR(255) NOT NULL, temps_cuisson INT NOT NULL, prix INT NOT NULL, PRIMARY KEY(id))');
